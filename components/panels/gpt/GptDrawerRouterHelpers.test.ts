...
describe("GptDrawerRouterHelpers", () => {
  ...
  it("builds settings drawer props and preserves reset/save handlers", () => {
    ...
    const settings: GptPanelSettingsProps = {
      ...
      libraryRagReferenceCount: 12,
      libraryRagCandidateCount: 100,
      libraryRagSimilarityThreshold: 0.3,
      ...
      onChangeAutoGenerateLibrarySummary: noop,
      onChangeSearchMode,
      ...
      onChangeLibraryRagReferenceEnabled: noop,
      onChangeLibraryRagReferenceCount: noop,
      onChangeLibraryRagCandidateCount: noop,
      onChangeLibraryRagSimilarityThreshold: noop,
