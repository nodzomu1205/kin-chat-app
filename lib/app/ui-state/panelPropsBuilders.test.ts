  ...
  it("builds GPT panel callbacks for task editing, count clamping, and request answers", () => {
    ...
    const props = buildGptPanelProps({
      ...
      settings: {
        ...
        onChangeImageLibraryImportEnabled: vi.fn(),
        onChangeImageLibraryImportMode: vi.fn(),
        onChangeAutoGenerateLibrarySummary: vi.fn(),
        ingestLoading: false,
        canInjectFile: true,
        searchMode: "normal",
        ...
        onChangeImageLibraryCardLimit: vi.fn(),
