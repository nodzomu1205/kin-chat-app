export const PRESENTATION_TASK_BASE_CONSTRAINTS = [
...
export const PRESENTATION_TASK_DECK_FRAME_CONSTRAINTS = [
...
export const PRESENTATION_TASK_FRAME_CONSTRAINTS = [
...
export const PRESENTATION_TASK_VISUAL_SLOT_CONSTRAINTS = [
...
export const PRESENTATION_TASK_RENDER_LAYOUT_CONSTRAINTS = [
...
export function presentationTaskModeConstraint(mode: "create" | "update") {
  return mode === "create"
