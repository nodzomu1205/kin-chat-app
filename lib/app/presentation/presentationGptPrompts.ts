...
export function buildCreatePresentationSpecPrompt(args: {
  ...
  return [
    ...
    "- top-level required fields: version, title, purpose, audience, language, density, theme, sourceIntent, slides",
    ...
    "- keyMessageFacts should contain the concrete support facts for that keyMessage; for detailed/dense outputs, prefer 3-8 facts per body when source information is available",
    ...
    "- keyVisual must include all fields: type, brief, assetId, status",
    ...
    "- script should explain what the slide should communicate, like speaker notes",
...
export function buildRepairPresentationSpecPrompt(args: {
  ...
  return [
    ...
    "      \"keyVisual\": { \"type\": string, \"brief\": string, \"assetId\": string, \"status\": string },",
