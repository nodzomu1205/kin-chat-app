...
export function buildTaskIntentFallbackPrompt(input: string, baseline: TaskIntent) {
  return [
    ...
    '- If USER_TEXT contains "コンテンツ取得5回まで", return kind "youtube_transcript_request", count 5, rule "up_to".',
    '- If USER_TEXT contains "1000文字以上", return kind "char_limit", charLimit 1000, rule "at_least". Never change "以上" into "exact".',
    '- If USER_TEXT contains "検索3回まで", return kind "search_request", count 3, rule "up_to".',
    ...
    '  "candidates": [',
    '    { "phrase": "検索3回まで", "draftText": "CAN search request up to 3 times", "kind": "search_request", "count": 3, "rule": "up_to", "charLimit": null },',
    '    { "phrase": "コンテンツ取得5回まで", "draftText": "CAN content request up to 5 times", "kind": "youtube_transcript_request", "count": 5, "rule": "up_to", "charLimit": null },',
