...
export function buildCompletionCriteria(intent: TaskIntent): string[] {
  const lines = [
...
export function formatCountInstruction(prefix: string, count: number, rule: TaskCountRule) {
  switch (rule) {
    case "at_least":
...
export function formatOptionalCountInstruction(prefix: string, count: number, rule: TaskCountRule) {
  switch (rule) {
    case "at_least":
...
export function buildRequiredWorkflow(intent: TaskIntent): string[] {
  const lines: string[] = [];
...
export function buildOptionalWorkflow(intent: TaskIntent): string[] {
  const lines: string[] = [];
