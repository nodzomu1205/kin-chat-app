...
function buildWorkspaceStateReferences(args: ChatPageWorkspaceStateReferences) {
  return {
    ...
    libraryRagIndexStates: args.libraryRagIndexStates,
    ...
    libraryRagReferenceEnabled: args.libraryRagReferenceEnabled,
    libraryRagReferenceCount: args.libraryRagReferenceCount,
    libraryRagCandidateCount: args.libraryRagCandidateCount,
    libraryRagSimilarityThreshold: args.libraryRagSimilarityThreshold,
    imageLibraryReferenceEnabled: args.imageLibraryReferenceEnabled,
    imageLibraryReferenceCount: args.imageLibraryReferenceCount,
    imageLibraryCardLimit: args.imageLibraryCardLimit,
