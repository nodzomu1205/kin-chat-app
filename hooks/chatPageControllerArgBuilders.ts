...
export function buildGptMessageActionArgs(
  ...
  return {
    ...
    applyImageUsage: groups.services.applyImageUsage,
    imageLibraryImportEnabled: groups.services.imageLibraryImportEnabled,
    imageLibraryImportMode: groups.services.imageLibraryImportMode,
