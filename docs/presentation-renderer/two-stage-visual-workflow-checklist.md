...
| 36 | API generation remains available | Resolve flow can mark a block for new image generation without requiring library image ID | Flow design/test | Pending |
